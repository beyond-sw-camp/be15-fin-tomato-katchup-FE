        ...
        <header class="w-full bg-white border-b border-gray-medium text-lg">
            <div class="flex justify-between items-center h-[90px]">
                ...
                <div class="flex-grow relative">
                    <nav class="flex">
                        <div v-for="(data, menu) in menuMap" :key="menu" class="cursor-pointer">
                            <button
                ...
                <div class="flex items-center gap-10 mr-5">
                    ...
                    <div class="flex items-center ml-4 gap-4">
                        <button>
                            <img src="@/assets/icons/calendar.svg" alt="캘린더" class="w-6 h-6" />
                        </button>
                        <button>
                            <img src="@/assets/icons/alarm.svg" alt="알림" class="w-6 h-6" />
                        </button>
                        <button>
                            <img src="@/assets/icons/logout.svg" alt="로그아웃" class="w-6 h-6" />
                        </button>
                    </div>
                </div>
            </div>

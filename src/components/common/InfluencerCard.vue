<template>
  <div class="relative w-[405px] min-h-[240px] p-4 border border-gray-light rounded-xl bg-white font-sans flex flex-col">
    <!-- 점 3개 버튼 -->
    <div class="absolute top-3 right-3">
      ...
      <div
        v-if="showDropdown"
        class="absolute top-0 right-7 flex flex-col bg-white border border-gray-medium rounded shadow-md z-10"
      >
        <div
    ...
    <div class="flex gap-3 items-start mb-3">
      <img
        ...
        alt="thumbnail"
        class="w-[100px] h-[100px] rounded-full object-cover border border-gray-light"
      />
      <div class="flex-1">
        <div class="flex items-center gap-1 text-base font-medium mb-1">
          <img :src="youtubeIcon" class="w-[18px] h-[18px]" alt="youtube" />
          <span class="font-bold text-click">{{ name }}</span>
        </div>
    ...
    <!-- 작성자 정보 -->
    <div class="flex items-center gap-1 text-sm text-gray-dark mt-auto pl-[2px]">
